    ...
    methods: {
        ...
        checkAnswer(option){
            ...
            if(this.checked===true){
                this.openPage('./ejercicios2Repaso.html');
            } else {
                if(this.selectedOp === ''){
...
const app2 = Vue.createApp({
    ...
    methods: {
        ...
        checkAnswer(option){
            ...
            if(this.checked===true){
                this.openPage('./ejercicios3Repaso.html');
            } else {
                if(this.selectedOp === ''){
                    warningDiv.style.display = 'block';
                } else if(this.selectedOp === option){
...
const app3 = Vue.createApp({
    ...
    methods: {
        ...
        checkAnswer(option){
            ...
            if(this.checked===true){
                this.openPage('./ejercicios4Repaso.html');
            } else {
                if(this.selectedOp === ''){
                    warningDiv.style.display = 'block';
                } else if(this.selectedOp === option){
...
const app4 = Vue.createApp({
    ...
    methods: {
        ...
        checkAnswer(option){
            ...
            if(this.checked===true){
                this.openPage('./ejercicios6Repaso.html');
            } else {
                if(this.selectedOp === ''){
                    warningDiv.style.display = 'block';
                } else if(this.selectedOp === option){
...
const app5 = Vue.createApp({
    ...
    methods: {
        ...
        checkAnswer(option){
            ...
            if(this.checked===true){
                this.openPage('./enhorabonaRepaso.html');
            } else {
                if(this.selectedOp === ''){
                    warningDiv.style.display = 'block';
                } else if(this.selectedOp === option){
